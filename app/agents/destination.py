...
def destination_node(state: TravelState) -> TravelState:
    ...
    try:
        ...
        return {"destination_search_request": search_request, "destination_candidates": [], "errors": [str(exc)], "messages": ["관광지 검색 서비스 호출에 실패했습니다."]}
    ...
    return {"destination_search_request": search_request, "destination_candidates": candidates, "messages": [f"관광지 후보 {len(candidates)}개를 찾았습니다."]}
